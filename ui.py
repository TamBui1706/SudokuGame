...
class SudokuApp(QWidget):
    ...
    def check_username(self):
        ...
        if len(username) < 1 or len(username) > 10:
            QMessageBox.warning(self, 'Warning', 'Username must be between 1 and 10 characters')
            return
    ...
    def show_main_menu(self):
        self.clear_layout()
        welcome_label = QLabel(f'Hello, {self.username}!', self)
